...
public class VideoCapture : NSObject{
    ...
    private func initCamera() -> Bool{
        ...
        if let _ = captureDevice.activeFormat.videoSupportedFrameRateRanges.filter({ (frameRateRange) -> Bool in
            ...
            captureDevice.activeVideoMinFrameDuration = CMTimeMake(value: 1, timescale: Int32(self.fps))
            captureDevice.activeVideoMaxFrameDuration = CMTimeMake(value: 1, timescale: Int32(self.fps))
        }
