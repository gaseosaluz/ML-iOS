...
// This structure inherits from UIViewControllerRepresentable in order to
// call UIImagePicker which is part of the older UIKit framework inside SwiftUI

// There is a lot of code below that simply allows SwiftUI to provide enough of
// UIKit's functionality so that it can call UIIMagePicker
...
// Add an extension to UIImage that llows to manipulate
// the orientation as needed
